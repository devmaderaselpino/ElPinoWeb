...
export default function EditEmployee() {
    ...
    useEffect( () =>{
        if(data){
            const datosActualizados = {
                ...
                nombres: data.getEmployee.nombre,
                apellidoPaterno: data.getEmployee.aPaterno,
                apellidoMaterno: data.getEmployee.aMaterno,
                telefono: data.getEmployee.celular,
                municipio: data.getEmployee.municipio,
                colonia: data.getEmployee.colonia,
                calle: data.getEmployee.calle,
                numeroExterior: data.getEmployee.numero_ext,
                usuario: data.getEmployee.usuario,
                contrasena: data.getEmployee.password,
                puesto: data.getEmployee.tipo
    ...
    if(loadingColonias || loadingMunicipios || loading || loadingUpdate){
        return (
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4">
            <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-4xl">
                <h2 className="text-2xl font-bold text-center mb-8 text-gray-800">Editar Empleado</h2>
